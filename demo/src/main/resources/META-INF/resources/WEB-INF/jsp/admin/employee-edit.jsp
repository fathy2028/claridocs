    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Edit Employee: ${employee.user.name}</h5>
            </div>
            <div class="card-body">
                                ...
                                <select class="form-select" id="departmentId" name="departmentId" required>
                                    ...
                                    <c:forEach var="dept" items="${departments}">
                                        <option value="${dept.id}" 
                                                <c:if test="${dept.id == employee.department.id}">selected</c:if>>
                                            ${dept.name}
                                        </option>
                                    </c:forEach>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="dateJoined" name="dateJoined"
                                       value="${employee.dateJoined}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
